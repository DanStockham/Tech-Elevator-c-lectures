...
namespace ProjectNamespace
{
    ...
    public class SkeletonClass
    {
        ...
        {
            this.y = 5; //assign some arbitary value to readonly field y
        }
        ...
        {
            this.privateVariable = requiredVariableValue;
        }
        ...
        {
            get { return this.privateVariable; }
            set { this.privateVariable = value; }
        }
        ...
        public static void DoSomethingStatic()
        {
            ...
            //the output of the function running is independent of instance
            //member variables
        }
