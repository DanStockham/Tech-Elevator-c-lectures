...
insert into countrylanguage (countrycode, language, isofficial, percentage) values ('XQR', 'Klingon', 0, 0);
...
insert into countrylanguage (countrycode, language, isofficial, percentage) values ('USA', 'Klingon', 0, 0);
...
insert into countrylanguage values ('USA', 'Klinglish', 0, 0);
...
insert into countrylanguage (percentage, isofficial, language, countrycode) values (0, 0,  'Englon', 'USA');
