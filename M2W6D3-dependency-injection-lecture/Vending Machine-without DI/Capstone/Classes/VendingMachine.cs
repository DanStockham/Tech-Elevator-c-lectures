...
namespace Capstone.Classes
{
    public class VendingMachine
    {
        ...
        //private InventorySqlDAL inventorySource = new InventorySqlDAL(localConnectionString);
        //private TransactionFileSqlLog transactionLogger = new TransactionFileSqlLog(localConnectionString);
